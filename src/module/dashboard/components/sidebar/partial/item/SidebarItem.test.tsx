import {fireEvent, render, screen} from "@/common/test/util";
import SidebarItem, {SidebarItemProps} from "@/module/dashboard/components/sidebar/partial/item/SidebarItem";
