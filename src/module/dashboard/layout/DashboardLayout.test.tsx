...
jest.mock("@/module/dashboard/components/header/Header", () =>
    // eslint-disable-next-line react/display-name
    () => <div data-testid="mock-header">Mock Header</div>
);

jest.mock("@/module/dashboard/components/header-responsive/HeaderResponsive", () =>
    // eslint-disable-next-line react/display-name
    () => <div data-testid="mock-header-responsive">Mock Responsive</div>
);

jest.mock("@/module/dashboard/components/sidebar/Sidebar", () =>
    // eslint-disable-next-line react/display-name
