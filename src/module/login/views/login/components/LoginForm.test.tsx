...
import {showFormNotification} from "@/module/login/views/login/helper/login-notification.helper";
...
jest.mock("@/module/login/views/login/helper/login-notification.helper", () => ({
